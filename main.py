...
def main():
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="If set to True, will only do OpenIE and stop before graph construction and doc insertion.",
    )
    parser.add_argument("--eval_retrieval", default="true")
    parser.add_argument("--eval_qa", default="true")
    parser.add_argument("--extract_method", default="openie")
    ...
    if "llama" in args.llm_name:
        config.extract_format = "json_schema"
    ...
    # Retrieval and QA
    remem.rag_for_qa(queries=all_queries, gold_docs=gold_docs, gold_answers=gold_answers)
